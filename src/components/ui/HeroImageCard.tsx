...
const HeroImageCard: React.FC<HeroImageCardProps> = ({
  ...
  const themeConfig = {
    student: {
      ...
      overlayGradient: 'from-blue-600/30 via-cyan-600/20 to-transparent',
    },
    mentor: {
      ...
      overlayGradient: 'from-purple-600/30 via-pink-600/20 to-transparent',
    },
  };
      ...
      <div className="relative h-full overflow-hidden rounded-2xl">
        ...
        {heroImageUrl && (
          <>
            ...
            />
            <div className={`absolute inset-0 bg-gradient-to-br ${config.overlayGradient}`} />
          </>
        )}
        
        {/* Floating Icons */}
        <FloatingImages theme={theme} />
        
        {/* Content Container */}
        <div className={`
          relative z-20 h-full p-8 
